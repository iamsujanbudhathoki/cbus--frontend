...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("font-bold text-slate-900 leading-tight tracking-tight text-base", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex items-center p-4 sm:p-5 pt-0 border-t border-slate-100 mt-4", className)}
    {...props}
  />
))
